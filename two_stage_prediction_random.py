...
write_list_to_file(filename_list, './train_test_split/all_files.txt')
...
description_scores_gpt4 = torch.load('./Results/descriptors_geode_gpt3/gpt4_contrastive_des_top10_two_stage_scores.pt')
description_scores_gpt35 = torch.load('./Results/descriptors_geode_gpt3/gpt35_contrastive_des_top10_two_stage_scores.pt')
...
write_list_to_file(selected_filename_list, './train_test_split/difficult_images.txt')
...
write_list_to_file(filename_list_train, './train_test_split/filename_list_train.txt')
write_list_to_file(filename_list_test, './train_test_split/filename_list_test.txt')


#get the index samples that top 2 prediction in to the selected pairs
...
for pair in list(index_dict_train.keys()):
    ...
    filelist_pair_train = filename_list_train[index_dict_train[pair]]
    filelist_pair_test = filename_list_test[index_dict_test[pair]]

    write_list_to_file(filelist_pair_train, './train_test_split/{}-{}-filename_list_train.txt'.format(label_to_classname[pair[0]],label_to_classname[pair[1]]))
    write_list_to_file(filelist_pair_test, './train_test_split/{}-{}-filename_list_test.txt'.format(label_to_classname[pair[0]],label_to_classname[pair[1]]))
    ...
    print(round(acc_contrastive_gpt4, 4))
    print(round(acc_des_gpt4, 4))
    print(round(acc_contrastive_gpt35, 4))
    print(round(acc_des_gpt35, 4))
